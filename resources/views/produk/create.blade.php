...
@section('content')
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form id="signupForm" action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <input type="hidden" class="form-control" id="input-10" name="id">
                <div class="form-group row">
                        {{-- <input type="text" class="form-control" id="input-10" name="stok" value="0"> --}}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <textarea class="form-control" name="description" rows="4" id="input-17"></textarea>
                        </div>
                      </div>
